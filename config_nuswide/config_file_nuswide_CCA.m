...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
DEVICE = 1; % 1, laptop 2, desktop (ubuntu, yoshinaga)

if 1 == DEVICE
    % Path for laptop
    IMAGE_SOURCE_DIR = '';
    IMAGE_ANNOTATION_DIR = 'C:\workspace\program\image-annotation\benchmark-dataset\NUS-WIDE\NUS-WIDE-crop\Low_Level_Features';
    RUN_DIR = './';
